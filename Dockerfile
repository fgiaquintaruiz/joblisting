...
EXPOSE 8080
CMD ["java","-jar","-Ddb.mongo.host=${MONGODB_HOST} -Ddb.mongo.user=${MONGODB_USER} -Ddb.mongo.password=${MONGODB_PASSWORD} -Ddb.mongo.port=${MONGODB_LOCAL_PORT}","joblisting-0.0.1.jar"]
